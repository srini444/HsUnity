...
public class Dot : MonoBehaviour
{
	...
	void Update ()
    {
        ...
        if (Input.GetMouseButtonUp(0))
            ...
            if (angle < -10.0F)
                {
                    dotInsstance.GetComponent<Rigidbody>().AddRelativeForce(new Vector3(Random.Range(-10.0f, 0f), Random.Range(-10.0f, 10.0f), Random.Range(50.0f, 10.0f)) * dotForce * Time.deltaTime, ForceMode.Impulse);
                    print("turn left");
                    Invoke("CreateDot", 3f);
                }
                ...
                {
                    dotInsstance.GetComponent<Rigidbody>().AddRelativeForce(new Vector3(Random.Range(0.0f, 10.0f), Random.Range(-10.0f, 10.0f), Random.Range(5.0f, 10.0f)) * dotForce * Time.deltaTime, ForceMode.Impulse);
                    print("turn right");
                    Invoke("CreateDot", 3f);
            }
